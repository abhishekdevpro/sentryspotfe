...
export default function PaymentPage() {
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-8 mt-20 overflow-x-hidden">
          ...
          <div className="p-8">
            ...
            <div className="mb-8">
              ...
              <div className="my-6">
                ...
                {selectedPlan &&
                  selectedPlan.billingCycle !== "single" &&
            ...
            {!isFreeplan && (
              <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                By clicking <strong>"Start applying"</strong> below, you agree
                to our
            ...
            {isFreeplan && (
              <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                By clicking <strong>"Start with Free Plan"</strong> below, you
                agree to our
                <a href="#" className="text-blue-600 hover:underline mx-1">
                  Terms of Use
                </a>
