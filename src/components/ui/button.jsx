...
//         secondary:
//           "bg-slate-700 text-slate-100 hover:bg-slate-900 dark:bg-slate-200 dark:text-slate-50 dark:hover:bg-slate-800/80",
...
const buttonVariants = cva(
  ...
  //   variants: {
  //     variant: {
  //       default: "bg-blue-900 text-primary-foreground hover:bg-primary/90",
  //       destructive:
